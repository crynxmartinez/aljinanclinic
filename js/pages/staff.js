        ...
        <div class="border-2 border-gray-200 rounded-lg p-4 hover:border-primary transition">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-gray-600"><i class="fas fa-envelope mr-2"></i>${apt.patientEmail}</p>
                    <p class="text-gray-600"><i class="fas fa-phone mr-2"></i>${apt.patientPhone}</p>
                </div>
                <div>
